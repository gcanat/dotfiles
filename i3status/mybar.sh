...
mycrypto() {
  ...
  echo -n "\"full_text\":\" $(/home/gui/.config/i3status/crypto.py) \","
  echo -n "\"color\":\"#000000\","
...
myip_public() {
  ...
  echo -n "\"full_text\":\" $(/home/gui/.config/i3status/ip.py) \","
  echo -n "\"background\":\"$bg\","
  common
  echo -n "},"
}
...
disk_usage() {
  ...
  echo -n "\"full_text\":\"  $(/home/gui/.config/i3status/disk.py)%\","
  echo -n "\"background\":\"$bg\","
  common
  echo -n "}"
}
...
memory() {
  ...
  echo -n "\"full_text\":\"  $(/home/gui/.config/i3status/memory.py)%\","
...
cpu_usage() {
  ...
  echo -n "\"full_text\":\"  $(/home/gui/.config/i3status/cpu.py)% \","
  echo -n "\"background\":\"#3949AB\","
  common
  echo -n "},"
}
...
meteo() {
  ...
  echo -n "\"full_text\":\" $(/home/gui/.config/i3status/meteo.py) \","
  echo -n "\"background\":\"$bg\","
  common
  echo -n "},"
}
...
do
  ...
  if [[ $line == *"name"*"id_vpn"* ]]; then
    alacritty -e /home/gui/.config/i3status/click_vpn.sh &

  # CHECK UPDATES
  elif [[ $line == *"name"*"id_systemupdate"* ]]; then
    alacritty -e /home/gui/.config/i3status/click_checkupdates.sh &
  ...
  # TIME
    ...
    alacritty -e /home/gui/.config/i3status/click_time.sh &
