...
-- map("v", "<leader>yo", [[<cmd>lua require('osc52').copy_visual()<CR>]], {noremap = true, silent = true, desc= 'Copy to clipboard'})
...
-- neo-tree toggle
map("n", "<F3>", ":Neotree toggle<CR>", { noremap = true, silent = true , desc ='Toggle NeoTree'})
